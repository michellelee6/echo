...
class AutoPairAgent(dbus.service.Object):
    ...
    def trust_device(bus, device_mac):
      ...
      try:
          ...
          print(f"[TRUST] Device {device_mac} trusted")
      except Exception as e:
          print(f"[TRUST] Failed to trust device {device_mac}: {e}")
...
if __name__ == "__main__":
    ...
    # *** Add your iPhone MAC address here ***
    iphone_mac = "10:A2:D3:B2:23:4B"
    trust_device(bus, iphone_mac)
